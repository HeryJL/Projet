 ...
 * @author Hery
 */
public class ModifVolServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
             int id_vol = Integer.parseInt(request.getParameter("id_vol"));
          ...
          request.getRequestDispatcher("Link?page=adminVol").forward(request, response);
            ...
            Logger.getLogger(ModifVolServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
